...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2025 at 11:35 AM
...
--
-- Table structure for table `apartment_names`
--

CREATE TABLE `apartment_names` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Dumping data for table `apartment_names`
--

INSERT INTO `apartment_names` (`id`, `name`, `created_at`) VALUES
(1, 'lucknow', '2025-07-03 07:46:19'),
(2, 'Amausi', '2025-07-03 07:46:32'),
(3, 'Alambhag', '2025-07-03 07:46:52');
...
(4, 'A', 'Amausi', '354', 'jljlk', 'test@gmail.com', '9874563210', '$2y$10$.EEBwdUpxhNSuzM6A/OX6ehmco2kfQJkdsjH1EsHSu5H7gBqdsBxK', '2025-07-03 08:22:10');
...
(5, 4, 2, 'jljlk', 20.00, 'Cash', '2025-07-03 08:22:42');
...
--
-- Indexes for table `apartment_names`
--
ALTER TABLE `apartment_names`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `apartment_names`
--
ALTER TABLE `apartment_names`
