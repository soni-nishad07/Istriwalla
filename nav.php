...
<div class="booking_modal" id="bookingModal" style="display: none;">
    <div class="booking_form_container">
        ...
        <form action="submit_order.php" method="POST">
            ...
            <input type="text" name="apartment_name" value="<?php echo htmlspecialchars($customer['apartment_name']); ?>" readonly />

            <label>Pin Code</label>
            <input type="text" name="pin_code" value="<?php echo htmlspecialchars($customer['pin_code']); ?>" readonly />

            <label>Address</label>
            <textarea name="address" required readonly><?php echo htmlspecialchars($customer['address']); ?></textarea>
